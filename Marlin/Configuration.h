...
#define STRING_CONFIG_H_AUTHOR "(Jens N, Ender 3 Modded)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Jens Ender 3"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 40, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -10, -2.00 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
